...
musicFile:       "data/bgm/music_melody.wav",
musicLoop:       false,
bgImage:         "",
returnStorage:   "",
returnTarget:    "*rhythm_after",
seVolume:        0.8,
sePerfect:       "data/sound/perfect.mp3",
seGood:          "data/sound/good.mp3",
seMiss:          "",
seEmpty:         "",
sePause:         "",
seResume:        "",
...
[if exp="f.rhythm_fullcombo == 1"]
[jump storage="result_kouzui.ks"]
[endif]
[if exp="f.rhythm_rate >= 30"]
[jump storage="result_success.ks"]
[else]
[jump storage="result_unsuccess.ks"]
[endif]
[_tb_end_tyrano_code]
